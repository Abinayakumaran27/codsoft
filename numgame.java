        ...
        for (int i = 1; i <= round; i++) {
            ...
            switch (lim) {
                ...
                case 2: {
                    ...
                    int t3 = 1;
                    whileloop: while (t3 <= 6) {
                        System.out.println("\nNo of guesses remaining : " + (7 - t3) + " ...\n");
                        System.out.print("Enter you guess number " + t3 + ": ");
                        int t4 = t1.nextInt();
                        if (t4 > randomNumber) {
                            System.out.println("The number " + t4
